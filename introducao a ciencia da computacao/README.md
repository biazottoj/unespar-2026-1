## Introducão a Ciencia da Computacão (2026-1)


---
### Atividades
- Atividade 01 - Introducão a Computacao
	+ Feita em Sala
- Atividade 02 - Tecnicas para percepcão de profundidade (até 31/03/2016)
	+ Link para entrega: [https://forms.gle/YX8CqLfABwJJmKndA](https://forms.gle/YX8CqLfABwJJmKndA) 
- Atividade 03 - Aliasing (até 07/04/2026 as 11:30)
...
- Prova no dia 05/05 (Terca-Feira)
	+ A prova vai ser em sala, no papel
	+ Até o dia 01/05 passo o material de revisão
- Não vai haver projeto nesse bimestre, as atividade vao contar como nota
	+ A prova vale 4,0
	+ São 3 atividades, cada uma velendo 2,0
	+ As atividades podem ser entregues até o dia 05/05.
	+ As atividades que foram entregues fora do prazo (de acordo com a secão anterior) vão valer metade da nota
- Atividades que foram feitas em sala podem ser entregues. Elas vão valer metade da nota (pois estão sendo entregues fora do prazo)
